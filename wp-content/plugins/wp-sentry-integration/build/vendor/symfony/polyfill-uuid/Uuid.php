 ...
 */
namespace WPSentry\ScopedVendor\Symfony\Polyfill\Uuid;
...
final class Uuid
{
    ...
    private static function parse($uuid)
    {
        ...
        return array('time' => '0' . $matches['time_hi'] . $matches['time_mid'] . $matches['time_low'], 'version' => \hexdec($matches['version']), 'clock_seq' => \hexdec($matches['clock_seq']), 'node' => $matches['node']);
    }
