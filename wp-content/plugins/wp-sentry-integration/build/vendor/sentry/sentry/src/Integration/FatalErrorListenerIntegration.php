 ...
 */
final class FatalErrorListenerIntegration implements \Sentry\Integration\IntegrationInterface
{
    /**
    ...
    public function setupOnce() : void
    {
        ...
        $errorHandler->addFatalErrorHandlerListener(function (\Sentry\Exception\FatalErrorException $exception) : void {
