 ...
 */
class ServerOsContext extends \Sentry\Context\Context
{
    /**
    ...
    {
        $resolver->setDefaults(['name' => \php_uname('s'), 'version' => \php_uname('r'), 'build' => \php_uname('v'), 'kernel_version' => \php_uname('a')]);
