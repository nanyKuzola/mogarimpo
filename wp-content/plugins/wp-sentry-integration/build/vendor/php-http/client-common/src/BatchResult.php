...
final class BatchResult
{
     ...
     */
    public function isSuccessful(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request) : bool
    {
     ...
     */
    public function getResponseFor(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request) : \WPSentry\ScopedVendor\Psr\Http\Message\ResponseInterface
    {
        try {
     ...
     */
    public function addResponse(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request, \WPSentry\ScopedVendor\Psr\Http\Message\ResponseInterface $response) : self
    {
        $new = clone $this;
     ...
     */
    public function isFailed(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request) : bool
    {
     ...
     */
    public function getExceptionFor(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request) : \WPSentry\ScopedVendor\Psr\Http\Client\ClientExceptionInterface
    {
        try {
     ...
     */
    public function addException(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request, \WPSentry\ScopedVendor\Psr\Http\Client\ClientExceptionInterface $exception) : self
    {
        $new = clone $this;
