...
final class PluginClientFactory
{
     ...
     */
    public function createClient($client, array $plugins = [], array $options = []) : \WPSentry\ScopedVendor\Http\Client\Common\PluginClient
    {
        ...
        return new \WPSentry\ScopedVendor\Http\Client\Common\PluginClient($client, $plugins, $options);
    }
}
