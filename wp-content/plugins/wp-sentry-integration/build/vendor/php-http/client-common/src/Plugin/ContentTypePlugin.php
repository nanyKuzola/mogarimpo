 ...
 */
final class ContentTypePlugin implements \WPSentry\ScopedVendor\Http\Client\Common\Plugin
{
    /**
    ...
    private function isJson(\WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream) : bool
    {
    ...
    private function isXml(\WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream) : bool
    {
