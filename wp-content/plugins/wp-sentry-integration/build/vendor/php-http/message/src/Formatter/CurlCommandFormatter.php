 ...
 */
class CurlCommandFormatter implements \WPSentry\ScopedVendor\Http\Message\Formatter
{
    /**
     * {@inheritdoc}
     */
     ...
     * @return string
     */
    private function getHeadersAsCommandOptions(\WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface $request)
    {
        $command = '';
