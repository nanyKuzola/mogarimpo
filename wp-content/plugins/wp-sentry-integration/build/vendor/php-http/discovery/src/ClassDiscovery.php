...
abstract class ClassDiscovery
{
     ...
     * @var array
     */
    private static $strategies = [\WPSentry\ScopedVendor\Http\Discovery\Strategy\PuliBetaStrategy::class, \WPSentry\ScopedVendor\Http\Discovery\Strategy\CommonClassesStrategy::class, \WPSentry\ScopedVendor\Http\Discovery\Strategy\CommonPsr17ClassesStrategy::class];
    /**
