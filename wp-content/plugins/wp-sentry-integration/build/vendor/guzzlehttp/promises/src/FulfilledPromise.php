 ...
 */
class FulfilledPromise implements \WPSentry\ScopedVendor\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \WPSentry\ScopedVendor\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
