 ...
 */
class MultipartStream implements \WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface
{
    ...
    private function addElement(\WPSentry\ScopedVendor\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
