 ...
 */
class AppendStream implements \WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream)
    {
