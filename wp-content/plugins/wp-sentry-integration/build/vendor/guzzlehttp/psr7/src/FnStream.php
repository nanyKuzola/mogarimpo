 ...
 */
class FnStream implements \WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
